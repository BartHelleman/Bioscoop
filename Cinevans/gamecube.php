...
$page_title = 'Retrogame-Shop - Gamecube';
...
// De SQL
$sql = "SELECT * FROM `PRODUCT` WHERE `CONSOLE` = 'GAMECUBE';"; 
...
<div id="left_sidebar_filter">
	<form action="supernintendo.php" method="post">
		...
		<table>
			<tr>
				<td><input type="checkbox" checked="yes" name="Action" value="Action"/>Action</td>
			</tr>
			<tr>
...
<!-- producten_gevonden laat hieronder zien hoeveel producten gevonden-->	
<div class="producten_gevonden">
<?php
// Laat zien wanneer er geen producten worden gevonden	
if($result === false) {
	echo "<p>Er zijn geen producten in de winkel gevonden.</p>\n";
} else {
	$num = 0;
