...
if (empty($_SESSION['cart'])) {
    ...
    foreach($cart as $products) {
      ...
      if (strlen(trim($product[1])) <> 0) {
		  // Get product info
		  $sql = "SELECT ProductNR, Productnaam, Prijs 
				  FROM PRODUCT
				  WHERE ProductNR = ".$product[0];  // Weet je nog, uit die sessie
		  ...
		  echo "<tbody>\n<tr>\n";
		  echo "  <td>".$pro_cart->ProductNR."</td>\n";   // nummer
		  echo "  <td>".$pro_cart->Productnaam."</td>\n";     // naam
		  echo "  <td><input type=\"hidden\" name=\"ProductNR_".$i."\" value=\"".$product[0]."\" />\n"; // wat onzichtbare vars voor het updaten
  ...
  <p>
  <ul>
		<div id="leegmaken_button"><li><a href="javascript:removeCart()">Winkelwagen leegmaken</a><br /></li>
		<div id="afrekenen_button"><li><a href="checkout.php">Afrekenen</a><br /></li></div>
		<div id="verderwinkelen_button"><li><a href="index.php">Verder winkelen</a></li></div>
	</ul>	
  </p>
  <?php
}
